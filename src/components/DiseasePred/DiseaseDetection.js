    ...
    <div class="container">
        <div class="card">
            ...
            <div class="content">
                ...
                <p>With more that 1 million cases in India every year, leading to dangerous complication if left
                    unchecked.</p>
                <a href="https://breastcancerdetectionweb.herokuapp.com/" target="blank">Predict Now</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <a href="https://diabetiespredictionweb.herokuapp.com/" target="blank">Predict Now</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <a href="https://heartdiseasepredictionweb.herokuapp.com/" target="blank">Predict Now</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <a href="https://kidneydiseasepredictionweb.herokuapp.com/" target="blank">Predict Now</a>
            </div>
        </div>
    </div>
  </>
